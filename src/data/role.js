...
const warehouse = {link: '#warehouses', name: 'Warehouses', icon: 'bx-home-alt'};
...
const role = {
    ...
    staffs: [profile, users, companies, sellers, goods, services, warehouse, settings],
    admin: [profile, users, companies, sellers, goods, services, warehouse, logs, settings]
};
export default role;
