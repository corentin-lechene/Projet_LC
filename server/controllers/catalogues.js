...
import {
    ...
    getCataloguesById,
    insertCatalogues,
    deleteCataloguesById,
    updateCataloguesById, getCataloguesByDate
} from "../models/cataloguesModel.js";
...
// Get All Catalogues
export const showCataloguesDate = (req, res) => {
    getCataloguesByDate((err, results) => {
        if (err){
            res.send(err);
        } else {
            res.json(results);
